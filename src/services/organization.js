...
export const PLANS_CONFIG = {
  ...
  business: {
    ...
    maxVehicles: 600,
    features: [
      "1 Parking grande capacité",
      "Jusqu'à 600 véhicules",
      "10 Utilisateurs inclus",
      "Assistant Récupération Pas-à-Pas",
      "Gestion d'équipe & Rôles RBAC",
  ...
  pro: {
    ...
    features: [
      "Jusqu'à 3 Parkings",
      "Jusqu'à 1 000 véhicules / parking",
      "20 Utilisateurs inclus",
      "Tous les algorithmes de tri & zonage",
      "Gestion multi-sites centralisée",
      "Statistiques & Analytics de rotation",
  ...
  enterprise: {
    ...
    features: [
      ...
      "Véhicules sur mesure (illimité)",
      "Utilisateurs sur mesure (illimité)",
      "Accompagnement & Déploiement sur site",
      "Développements & Intégrations sur-mesure",
